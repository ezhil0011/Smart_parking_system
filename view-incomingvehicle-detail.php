...
<head>
    ...
    <title>NED Fishermen Detail</title>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="manage-incomingvehicle.php">View Boat</a></li>
                                    <li class="active">Incoming Boat</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">View Incoming Boat</strong>
                        </div>
                        <div class="card-body">
